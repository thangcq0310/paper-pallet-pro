    ...
    <div className="print-area p-6">
      ...
      <Card className="rounded-2xl border-2 border-foreground">
        <CardContent className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              <div className="text-xs text-muted-foreground uppercase">From Location</div>
              <div className="font-mono">{task.fromLocation}</div>
            </div>
            <div>
              <div className="text-xs text-muted-foreground uppercase">To Location</div>
              <div className="font-mono">{task.toLocation}</div>
            </div>
            <div className="sm:col-span-2">
              <div className="text-xs text-muted-foreground uppercase">Actual Location (ghi tay)</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
            ...
            <div>
              <div className="text-xs text-muted-foreground mb-1">Người xác nhận</div>
              <div className="border-b border-foreground/40 h-8" />
            </div>
            <div className="sm:col-span-2">
              <div className="text-xs text-muted-foreground mb-1">Ghi chú thực tế</div>
